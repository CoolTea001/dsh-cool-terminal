...
- The console the tab was last showing is remembered too: a reload reopens that console — revealing its group if it was collapsed — instead of jumping back to the first group's first console.
